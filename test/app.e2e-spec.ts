...
describe('AppController (e2e)', () => {
  ...
  describe(`/ (GET)`, () => {
    ...
    it(`should return 401 Unauthorized when an invalid x-api-key is passed in`, () => {
  ...
  describe(`/?index=X (GET)`, () => {
    ...
    it('should return a 400 if a non-number index is passed in', () => {
      return request(app.getHttpServer())
    ...
    it('should return a 400 if a negative index is passed in', () => {
      return request(app.getHttpServer())
        .get(`/?index=-1`)
        .set(`x-api-key`, `SECRET`)
        .expect(400);
